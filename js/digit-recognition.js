...
model = await tf.loadLayersModel("https://raw.githubusercontent.com/bensonruan/Hand-Written-Digit-Recognition/master/models/model.json");
...
function displayLabel(data) {
	...
	$(".prediction-text").html("<h2>You draw "+maxIndex+"</h2>")
}
